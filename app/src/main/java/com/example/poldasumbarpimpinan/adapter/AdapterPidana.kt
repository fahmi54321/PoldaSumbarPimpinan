...
import kotlinx.android.synthetic.main.item_get_pidana.view.*
import kotlinx.android.synthetic.main.item_get_pidana.view.buttonDetails
import kotlinx.android.synthetic.main.item_get_pidana.view.jabatan
import kotlinx.android.synthetic.main.item_get_pidana.view.nama_pelaku
import kotlinx.android.synthetic.main.item_get_pidana.view.nama_pelapor
import java.util.*

class AdapterPidana(
    var data:List<ResultItemPidana?>?,
    var context: Context):RecyclerView.Adapter<AdapterPidana.PidanaViewHolder>() {
    class PidanaViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
        ...
        var id_pidana = itemView.id_pidana
        var buttonDetails = itemView.buttonDetails
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PidanaViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.item_get_pidana,parent,false)
        var holder =
            PidanaViewHolder(view)
        return holder
    }
    ...
    override fun onBindViewHolder(holder: PidanaViewHolder, position: Int) {
        ...
        holder.id_pidana.text = data?.get(position)?.idPidana
